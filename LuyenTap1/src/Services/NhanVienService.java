...
public class NhanVienService implements INhanVienService{
    ...
    public ArrayList<QLNhanVien> getList() {
        ...
        var x = nvRP.all();
        for (NhanVien n : x) {
            QLNhanVien al = new QLNhanVien();
            al.setHo(n.getHo());
            al.setTenDem(n.getTenDem());
            al.setTen(n.getTen());
            al.setHoVaTen(n.getHo()+n.getTenDem()+n.getTen());
            listNV.add(new QLNhanVien(n.getMa(),n.getTen(),n.getTenDem(),n.getHo(),al.getHoVaTen(),n.getGioiTinh(),n.getSdt()));
        }
        return listNV;
    }
    ...
    public QLNhanVien insert(QLNhanVien n) {
        var x = nvRP.insert(new NhanVien(n.getMa(), n.getTen(), n.getTenDem(), n.getHo(), n.getGioiTinh(), n.getSdt()));
