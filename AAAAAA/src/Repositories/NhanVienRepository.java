...
public class NhanVienRepository {
    ...
    public void insert(NhanVien nv) {
        try {
            ...
            String query = "INSERT INTO nhan_vien(ma_nv, ten_nv, gioi_tinh, nam_sinh, chuc_vu, so_gio_lam, luong, anh) "
                    + "VALUES ( ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public ArrayList<NhanVien> getSearch(String maNv1) {
        ...
        try {
            ...
            while (rs.next()) {                
                ...
                NhanVien nv = new NhanVien(maNv, tenNv, gioiTinh, namSinh, chucVu, soGioLam, luong, anh);
                listNv.add(nv);
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
